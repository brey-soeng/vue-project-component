<template>
  <div>
    <tool-tip position="bottom" :tooltipText="'Notification'">
      ...
      >
        <div
          class="p-2 relative flex justify-center items-center rounded-full hover:text-secondary-900 active:bg-primary-600 active:text-white hover:bg-default-100 hover:opacity-70 hover:dark:bg-secondary-700 hover:dark:opacity-70 hover:dark:text-white"
        >
